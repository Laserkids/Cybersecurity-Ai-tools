...
def main():
    ...
    print(f"{Fore.CYAN}")
    print("=" * 70)
    print(f"           NMAP PORT SCANNER - {os_name} {os_version}")
    print("=" * 70)
    ...
    if not check_nmap_installed():
        ...
        print(f"  Kali/Debian/Ubuntu: sudo apt install nmap")
        print(f"  Fedora/RHEL: sudo dnf install nmap")
        print(f"  Arch Linux: sudo pacman -S nmap")
        sys.exit(1)
